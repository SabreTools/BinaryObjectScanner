...
namespace BinaryObjectScanner.Wrappers
{
    public class NewExecutable : WrapperBase
    {
        ...
        public BinaryObjectScanner.Models.NewExecutable.HeaderFlag FlagWord => _executable.Header.FlagWord;
        ...
        public BinaryObjectScanner.Models.NewExecutable.OperatingSystem TargetOperatingSystem => _executable.Header.TargetOperatingSystem;

        /// <inheritdoc cref="Models.NewExecutable.ExecutableHeader.AdditionalFlags"/>
        public BinaryObjectScanner.Models.NewExecutable.OS2Flag AdditionalFlags => _executable.Header.AdditionalFlags;
        ...
        public BinaryObjectScanner.Models.NewExecutable.SegmentTableEntry[] SegmentTable => _executable.SegmentTable;

        /// <inheritdoc cref="Models.NewExecutable.ResourceTable"/>
        public BinaryObjectScanner.Models.NewExecutable.ResourceTable ResourceTable => _executable.ResourceTable;

        /// <inheritdoc cref="Models.NewExecutable.ResidentNameTable"/>
        public BinaryObjectScanner.Models.NewExecutable.ResidentNameTableEntry[] ResidentNameTable => _executable.ResidentNameTable;

        /// <inheritdoc cref="Models.NewExecutable.ModuleReferenceTable"/>
        public BinaryObjectScanner.Models.NewExecutable.ModuleReferenceTableEntry[] ModuleReferenceTable => _executable.ModuleReferenceTable;
        ...
        public BinaryObjectScanner.Models.NewExecutable.EntryTableBundle[] EntryTable => _executable.EntryTable;

        /// <inheritdoc cref="Models.NewExecutable.NonResidentNameTable"/>
        public BinaryObjectScanner.Models.NewExecutable.NonResidentNameTableEntry[] NonResidentNameTable => _executable.NonResidentNameTable;
        ...
        /// </summary>
        private BinaryObjectScanner.Models.NewExecutable.Executable _executable;
        ...
        private void PrintEntryTable(StringBuilder builder)
        {
            ...
            else
            {
                for (int i = 0; i < EntryTable.Length; i++)
                {
                    ...
                    {
                        case BinaryObjectScanner.Models.NewExecutable.SegmentEntryType.FixedSegment:
                            ...
                            break;
                        case BinaryObjectScanner.Models.NewExecutable.SegmentEntryType.MoveableSegment:

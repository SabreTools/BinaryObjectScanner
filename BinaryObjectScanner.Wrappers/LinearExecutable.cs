...
namespace BinaryObjectScanner.Wrappers
{
    public class LinearExecutable : WrapperBase
    {
        ...
        public BinaryObjectScanner.Models.LinearExecutable.ByteOrder ByteOrder => _executable.InformationBlock.ByteOrder;

        /// <inheritdoc cref="Models.LinearExecutable.InformationBlock.WordOrder"/>
        public BinaryObjectScanner.Models.LinearExecutable.WordOrder WordOrder => _executable.InformationBlock.WordOrder;
        ...
        public BinaryObjectScanner.Models.LinearExecutable.CPUType CPUType => _executable.InformationBlock.CPUType;

        /// <inheritdoc cref="Models.LinearExecutable.InformationBlock.ModuleOS"/>
        public BinaryObjectScanner.Models.LinearExecutable.OperatingSystem ModuleOS => _executable.InformationBlock.ModuleOS;
        ...
        public BinaryObjectScanner.Models.LinearExecutable.ModuleFlags ModuleTypeFlags => _executable.InformationBlock.ModuleTypeFlags;
        ...
        public BinaryObjectScanner.Models.LinearExecutable.ObjectTableEntry[] ObjectTable => _executable.ObjectTable;

        /// <inheritdoc cref="Models.LinearExecutable.ObjectPageMap"/>
        public BinaryObjectScanner.Models.LinearExecutable.ObjectPageMapEntry[] ObjectPageMap => _executable.ObjectPageMap;

        /// <inheritdoc cref="Models.LinearExecutable.ResourceTable"/>
        public BinaryObjectScanner.Models.LinearExecutable.ResourceTableEntry[] ResourceTable => _executable.ResourceTable;
        ...
        public BinaryObjectScanner.Models.LinearExecutable.EntryTableBundle[] EntryTable => _executable.EntryTable;

        /// <inheritdoc cref="Models.LinearExecutable.ModuleFormatDirectivesTable"/>
        public BinaryObjectScanner.Models.LinearExecutable.ModuleFormatDirectivesTableEntry[] ModuleFormatDirectivesTable => _executable.ModuleFormatDirectivesTable;

        /// <inheritdoc cref="Models.LinearExecutable.VerifyRecordDirectiveTable"/>
        public BinaryObjectScanner.Models.LinearExecutable.VerifyRecordDirectiveTableEntry[] VerifyRecordDirectiveTable => _executable.VerifyRecordDirectiveTable;

        /// <inheritdoc cref="Models.LinearExecutable.PerPageChecksumTable"/>
        public BinaryObjectScanner.Models.LinearExecutable.PerPageChecksumTableEntry[] PerPageChecksumTable => _executable.PerPageChecksumTable;

        /// <inheritdoc cref="Models.LinearExecutable.FixupPageTable"/>
        public BinaryObjectScanner.Models.LinearExecutable.FixupPageTableEntry[] FixupPageTable => _executable.FixupPageTable;

        /// <inheritdoc cref="Models.LinearExecutable.FixupRecordTable"/>
        public BinaryObjectScanner.Models.LinearExecutable.FixupRecordTableEntry[] FixupRecordTable => _executable.FixupRecordTable;

        /// <inheritdoc cref="Models.LinearExecutable.ImportModuleNameTable"/>
        public BinaryObjectScanner.Models.LinearExecutable.ImportModuleNameTableEntry[] ImportModuleNameTable => _executable.ImportModuleNameTable;

        /// <inheritdoc cref="Models.LinearExecutable.ImportModuleProcedureNameTable"/>
        public BinaryObjectScanner.Models.LinearExecutable.ImportModuleProcedureNameTableEntry[] ImportModuleProcedureNameTable => _executable.ImportModuleProcedureNameTable;

        /// <inheritdoc cref="Models.LinearExecutable.NonResidentNamesTable"/>
        public BinaryObjectScanner.Models.LinearExecutable.NonResidentNamesTableEntry[] NonResidentNamesTable => _executable.NonResidentNamesTable;
        ...
        public BinaryObjectScanner.Models.LinearExecutable.DebugFormatType? DI_FormatType => _executable.DebugInformation?.FormatType;
        ...
        /// </summary>
        private BinaryObjectScanner.Models.LinearExecutable.Executable _executable;
                ...
                for (int i = 0; i < EntryTable.Length; i++)
                {
                    ...
                    if (bundle.TableEntries != null && bundle.TableEntries.Length != 0)
                    {
                        ...
                        for (int j = 0; j < bundle.TableEntries.Length; j++)
                        {
                            ...
                            switch (bundle.BundleType & ~BinaryObjectScanner.Models.LinearExecutable.BundleType.ParameterTypingInformationPresent)
                            {
                                case BinaryObjectScanner.Models.LinearExecutable.BundleType.UnusedEntry:
                                    builder.AppendLine($"      Unused, empty entry");
                                    break;

                                case BinaryObjectScanner.Models.LinearExecutable.BundleType.SixteenBitEntry:
                                ...
                                case BinaryObjectScanner.Models.LinearExecutable.BundleType.TwoEightySixCallGateEntry:
                                ...
                                case BinaryObjectScanner.Models.LinearExecutable.BundleType.ThirtyTwoBitEntry:
        ...
        private void PrintFixupRecordTable(StringBuilder builder)
        {
            ...
            else
            {
                for (int i = 0; i < FixupRecordTable.Length; i++)
                {
                    ...
                    // Source list flag
                    if (entry.SourceType.HasFlag(BinaryObjectScanner.Models.LinearExecutable.FixupRecordSourceType.SourceListFlag))
                    ...
                    // OBJECT / TRGOFF
                    if (entry.TargetFlags.HasFlag(BinaryObjectScanner.Models.LinearExecutable.FixupRecordTargetFlags.InternalReference))
                    {
                        ...
                        if (!entry.SourceType.HasFlag(BinaryObjectScanner.Models.LinearExecutable.FixupRecordSourceType.SixteenBitSelectorFixup))
                        {
                            // 32-bit Target Offset Flag
                            if (entry.TargetFlags.HasFlag(BinaryObjectScanner.Models.LinearExecutable.FixupRecordTargetFlags.ThirtyTwoBitTargetOffsetFlag))
                    ...
                    else if (entry.TargetFlags.HasFlag(BinaryObjectScanner.Models.LinearExecutable.FixupRecordTargetFlags.ImportedReferenceByOrdinal))
                    {
                        ...
                        if (entry.TargetFlags.HasFlag(BinaryObjectScanner.Models.LinearExecutable.FixupRecordTargetFlags.EightBitOrdinalFlag))
                            builder.AppendLine(value: $"    Imported ordinal number: {entry.ImportedOrdinalNumberByte} (0x{entry.ImportedOrdinalNumberByte:X})");
                        else if (entry.TargetFlags.HasFlag(BinaryObjectScanner.Models.LinearExecutable.FixupRecordTargetFlags.ThirtyTwoBitTargetOffsetFlag))
                        ...
                        // Additive Fixup Flag
                        if (entry.TargetFlags.HasFlag(BinaryObjectScanner.Models.LinearExecutable.FixupRecordTargetFlags.AdditiveFixupFlag))
                        {
                            // 32-bit Additive Flag
                            if (entry.TargetFlags.HasFlag(BinaryObjectScanner.Models.LinearExecutable.FixupRecordTargetFlags.ThirtyTwoBitAdditiveFixupFlag))
                    ...
                    // ORD # / ADDITIVE
                    else if (entry.TargetFlags.HasFlag(BinaryObjectScanner.Models.LinearExecutable.FixupRecordTargetFlags.InternalReferenceViaEntryTable))
                    {
                        // 16-bit Object Number/Module Ordinal Flag
                        if (entry.TargetFlags.HasFlag(BinaryObjectScanner.Models.LinearExecutable.FixupRecordTargetFlags.SixteenBitObjectNumberModuleOrdinalFlag))
                            builder.AppendLine($"    Target object number: {entry.TargetObjectNumberWORD} (0x{entry.TargetObjectNumberWORD:X})");

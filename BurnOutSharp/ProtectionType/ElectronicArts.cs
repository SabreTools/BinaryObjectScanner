namespace BurnOutSharp.ProtectionType
{
    public class ElectronicArts : IContentCheck
    {
        ...
        public string CheckContents(string file, byte[] fileContent, bool includePosition = false)
        {
            ...
            // TODO: Figure out a better variant of this that doesn't over-match
            ...
            // check = new byte[] { 0x49, 0x00, 0x6E, 0x00, 0x74, 0x00, 0x65, 0x00, 0x72, 0x00, 0x6E, 0x00, 0x61, 0x00, 0x6C, 0x00, 0x4E, 0x00, 0x61, 0x00, 0x6D, 0x00, 0x65, 0x00, 0x00, 0x00, 0x45, 0x00, 0x52, 0x00, 0x65, 0x00, 0x67, 0x00 };
            // if (fileContent.Contains(check, out position))
            //     return $"EA CdKey Registration Module {Utilities.GetFileVersion(file)}" + (includePosition ? $" (Index {position})" : string.Empty);

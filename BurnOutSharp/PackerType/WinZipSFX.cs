...
namespace BurnOutSharp.PackerType
{
    ...
    0x06 };
            if (fileContent.Contains(check, out int position4))
    ...
    0x56, 0x1E, 0x06, 0xC4, 0x7E, 0x0A, 0xC5 };
            if (fileContent.Contains(check, out int position5))
    ...
    0x56, 0x57, 0x39, 0x35, 0x53, 0x45, 0x2E, 0x53, 0x46, 0x58 };
            if (fileContent.Contains(check, out int position6))
    ...
    0x56, 0x57, 0x39, 0x35, 0x53, 0x52, 0x45, 0x2E, 0x53, 0x46, 0x58 };
            if (fileContent.Contains(check, out int position7))
    ...
    0x30, 0x31, 0x00, 0x00, 0x00, 0x01, 0x00, 0x08, 0x00, 0x11, 0x00, 0x00,
    0x06 };
            if (fileContent.Contains(check, out int position8))

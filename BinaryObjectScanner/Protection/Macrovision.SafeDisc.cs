...
namespace BinaryObjectScanner.Protection
{
    ...
    public partial class Macrovision
    {
        ...
        internal ConcurrentQueue<string> SafeDiscCheckDirectoryPath(string path, IEnumerable<string>? files)
        {
            var matchers = new List<PathMatchSet>
            {
                ...
                new PathMatchSet(new List<PathMatch>
                {
                    ...
                    new PathMatch("SPLSH16.BMP", useEndsWith: true),
                    new PathMatch("SPLSH256.BMP", useEndsWith: true),
        ...
        internal static string GetSafeDiscSplshVersion(string firstMatchedString, IEnumerable<string>? files)
        {
            ...
            // "00000406.016": Found in SafeDisc version 2.51.021 (Redump entry 66852).
            // "00000406.256": Found in SafeDisc version 2.51.021 (Redump entry 66852).

...
As noted above, `BurnOutSharp` has a few tricks up its sleeve, mainly in the form of `BurnOutSharp.Wrappers`. This library was written explicitly to make research and implementation as easy as possible, and as such, allows for a lot of very creative ways of finding protections.
